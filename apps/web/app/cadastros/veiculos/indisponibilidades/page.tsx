...
export const metadata = { title: 'Indisponibilidades de ativos' };
export default function Page({ searchParams }: Readonly<{ searchParams: QualificationSearchParams }>) {
  return <QualificationResourcePage config={qualificationConfigs['asset-unavailability']} searchParams={searchParams} />;
}
