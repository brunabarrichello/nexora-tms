...
export const metadata = { title: 'Planos de manutenção' };
export default function Page({ searchParams }: Readonly<{ searchParams: QualificationSearchParams }>) {
  return <QualificationResourcePage config={qualificationConfigs['asset-maintenance-plan']} searchParams={searchParams} />;
}
