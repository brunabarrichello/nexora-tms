...
export const metadata = { title: 'Manutenções de ativos' };
export default function Page({ searchParams }: Readonly<{ searchParams: QualificationSearchParams }>) {
  return <QualificationResourcePage config={qualificationConfigs['asset-maintenance']} searchParams={searchParams} />;
}
