...
const allowed = new Set(['location', 'department', 'cost-center', 'commodity', 'party-group', 'custom-field']);

export default async function Page({ params }: Readonly<{ params: Promise<{ resource: string }> }>) {
