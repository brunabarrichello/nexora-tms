...
test(
  'password recovery config normalizes the Auth0 domain and requires the database connection',
  () => {
...
test(
  'Nexora does not reimplement PKCE, token exchange or Web-session cryptography',
  async () => {
